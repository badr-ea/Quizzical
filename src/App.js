...
export default function App() {
    ...
    function handleCheck() {
        ...
        setQuiz(questions => questions.map(question => {
    ...
    return (
        <div>
            ...
            <div className="end">
                {isRevealed ?
                <div className="check" onClick={handleCheck}>Check answers</div>
                :
                <div className="results">
                    <span className="score">You scored {correct}/{number} correct answers</span>
                    <div className="again" onClick={handlePlayAgain}>Play Again</div>
                </div>
                }
            </div>
            }
